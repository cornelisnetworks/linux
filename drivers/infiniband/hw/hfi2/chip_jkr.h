...
void jkr_enable_rcv_ctxt_pidx(struct hfi2_devdata *dd, u8 pidx, u16 ctxt, bool enable);
void jkr_update_rcv_hdr_size_pidx(struct hfi2_devdata *dd, u8 pidx, u16 ctxt, u32 size);
